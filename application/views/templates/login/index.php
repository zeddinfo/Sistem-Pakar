...
<html lang="en">
<head>
	<title>Login | Sistem Pakar Penyakit Bumil</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<section class="login100-form validate-form">
					...
					<div class="w-full text-center p-t-27 p-b-239" >
						...
						<a href="https://blogbugabagi.blogspot.com" target="_blank" class="txt2" style="color: #3EA8FF" style="font-family: arial">
							BlogBugaBagi
						</a>
					</div>
